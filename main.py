...
async def start_spam(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if update.message.reply_to_message:
        ...
        return await update.message.reply_text("ဘယ်သူ့ကိုဆဲရမလဲဆရာ (Reply ပြန်ပါ သို့မဟုတ် ID/Username ထည့်ပါ)")

    messages = [
        "ဟိတ် တအားအဆဲခံနေရလို့ဂုဏ်ယူမနေနဲ့အုံး နော် အီကိုမင်းကိုကြည့်မရလို့ဆဲနေတာ ပုကျိပုကျိစာကလေး လို့အော်ပြရင် ဆဲနေတာရပ်ပေးမယ် မင်းအမေစောက်ဖုတ်ကိုငါလီးနဲ့ထိုးသွင်းပီး တစ်ဇွတ်ထိုးဖြဲလိုးတဲ့ ​အထာကျတဲ့အီကိုရဲ့စတိုင်လန်းတဲ့ လီးကိုမှီချင်ရင်တော့ ဘုရားသခင်ဆီသာ တစ်နေကုန်သာဆုတောင်းနေတော့ဟေး😈👈", 
        ...
        "ကြောက်ရွံ မှုတွေရဲ့အထက်မှု မှာမင်းရဲ့အဖေ အီကိုပဲရှိတယ် မယုံရင်ကောင်းကင်ကြီးကို အော်ပြီးမေးလိုက်ရလဒ်ကတော့ အီကိုကမင်းအဖေဖြစ်တယ်ဆိုတာ မိုးကျိုးပစ်ပြီးမင်းကိုသတ်သေပြလိမ့်မယ်🤪👈", 
        "မင်းအမေစောက်ဖုတ်ကိုဂျွမ်းပြစ်လိုး လိုက်ရ ကမ္ဘာ့အပြင်ဘက်ကိုရောက်ရုံတောင်မက Alien တွေနဲ့ပါမိတ်လိုက်ပြီးလျှပ်စီးတွေလက်ကုန်မယ် ကောင်းကင်မှာ လျှပ်စီးလက်ရင် မင်းအမေနဲ့ဂြိုလ်သားလိုးနေတယ်လို့သာမှတ်ထားလိုက် 😳👈"
    ]

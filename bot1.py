...
BOT_TOKEN = "8959700806:AAHNnxpsRiOb1DztUFwMPVkRYxCCIvN_9cs"
...
async def attack_user(event):
    ...
    if event.is_reply:
        ...
        if len(args) < 2:
            return await event.reply("မျိုးမစစ်တွေကိုနှိမ်နှင်းစေချင်ရင်အမိန့်ကို မှန်ကန်စွာအသုံးပြုပါ (သတ်ပလိုက်) (Reply)")
        try:
